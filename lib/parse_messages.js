...
function parseRawComment(rawComment) {
  ...
  var _ref2 = (function () {
    ...
    try {
      for (var _iterator = _core.getIterator(splitN(rawComment, "|", 1)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function _getSerializedAttrs(node) {
  ...
  try {
    for (var _iterator2 = _core.getIterator(ifNull(treeAdapter.getAttrList(node), [])), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function _parseNode(node, placeholderRegistry) {
  ...
  try {
    for (var _iterator3 = _core.getIterator(treeAdapter.getChildNodes(node)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function _findAttrib(node, attrName) {
  ...
  try {
    for (var _iterator4 = _core.getIterator(ifNull(treeAdapter.getAttrList(node), [])), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
