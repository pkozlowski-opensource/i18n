...
function _repeatN(n, value, finalValue) {
  ...
  _assert2["default"](n >= 0 && Math.floor(n) == n, "n must be an integer >= 0");
  return function next() {
    if (n == 0) {
      return finalValue;
    } else {
...
function splitN(text, separator, maxTimes, fromRight) {
  _assert2["default"](maxTimes === void 0 || maxTimes >= -1 && Math.floor(maxTimes) == maxTimes, "maxTimes must be an integer >= -1");
  _assert2["default"](separator != "" && typeof separator == "string", "separator cannot be an empty string");
